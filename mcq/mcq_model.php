...
public function add_mcq()
{
    ...
    try
    {
        ...
        $insertQuery .= "(`statement`,`answer1`,`answer2`,`answer3`,`answer4`,`answer5`,`correctanswer`) ";
        $insertQuery .= " VALUES ";
        $insertQuery .= "(:statement,:answer1,:answer2,:answer3,:answer4,:answer5,:correctanswer);";
...
public function update_mcq()
{
    ...
    try
    {
        ...
        $updateQuery .= " `statement` = :statement , `answer1`= :answer1,`answer2` = :answer2, `answer3` = :answer3 ,`answer4` = :answer4,`answer5`= :answer5,`correctanswer` = :correctanswer ";
